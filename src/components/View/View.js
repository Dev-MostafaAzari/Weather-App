                            ...
                            <div className="WeatherEffectContainer">
                                ...
                                <div className="ViewTitleContainer">
                                    <motion.div variants={ViewTitleVariants} initial="initial" whileInView="animate">
                                        <motion.h1 variants={ViewTitleVariants} className="ViewTitle">Temperature:<motion.span variants={ViewTitleVariants}>{data.weather.data.main.temp}C</motion.span></motion.h1>
                                    </motion.div>
                                </div>
                            </div>
                        </div>
